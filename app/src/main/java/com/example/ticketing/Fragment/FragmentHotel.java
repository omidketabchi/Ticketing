...
public class FragmentHotel extends Fragment implements DatePickerDialog.OnDateSetListener, View.OnClickListener {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_ADD_DESTINATION_CITY && resultCode == RESULT_OK && data != null) {
