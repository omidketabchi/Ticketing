...
public class FragmentTrain extends Fragment implements DatePickerDialog.OnDateSetListener, View.OnClickListener {
    ...
    private void setupViews() {
        ...
        txtSource = (TextView) view.findViewById(R.id.txt_fragmentTrain_source);
        txtDestination = (TextView) view.findViewById(R.id.txt_fragmentTrain_destination);
        txtDate = (TextView) view.findViewById(R.id.txt_fragmentTrain_date);
        txtPassengers = (TextView) view.findViewById(R.id.txt_fragmentTrain_passengers);
        btnSearch = (Button) view.findViewById(R.id.btn_fragmentTrain_search);
        ...
        txtPassengers.setOnClickListener(this::onClick);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.txt_fragmentTrain_source:
                getCities(REQUEST_ADD_SOURCE_CITY);
                break;
            case R.id.txt_fragmentTrain_destination:
                getCities(REQUEST_ADD_DESTINATION_CITY);
                break;
            case R.id.txt_fragmentTrain_date:
                getDate();
                break;
            case R.id.txt_fragmentTrain_passengers:
                showPassengerDialog();
                break;
            case R.id.btn_fragmentTrain_search:
                showAllCities();
                break;
        }
    }
    ...
    private void showPassengerDialog() {
        ...
        FragmentDialogPassenger dialogPassenger = new FragmentDialogPassenger();

        dialogPassenger.show(((AppCompatActivity) getContext()).getSupportFragmentManager(), null);

        dialogPassenger.setOnDialogPassengerSubmitClick(new FragmentDialogPassenger.OnDialogPassengerSubmitClick() {
            @Override
            public void onSubmitClick(String numberOfNormalPassengers, String numberOfBrotherPassengers, String numberOfSisterPassengers) {
                txtPassengers.setText(numberOfNormalPassengers);
            }
        });
    }
}
