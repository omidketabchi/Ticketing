...
public class FragmentOutsideFlight extends Fragment implements DatePickerDialog.OnDateSetListener, View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.fragment_outside_flight, container, false);
    ...
    private void setupViews() {
        ...
        txtSource = (TextView) view.findViewById(R.id.txt_fragmentOutsideFlight_source);
        txtDestination = (TextView) view.findViewById(R.id.txt_fragmentOutsideFlight_destination);
        txtDate = (TextView) view.findViewById(R.id.txt_fragmentOutsideFlight_date);
        btnSearch = (Button) view.findViewById(R.id.btn_fragmentOutsideFlight_search);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.txt_fragmentOutsideFlight_source:
                getCities(REQUEST_ADD_SOURCE_CITY);
                break;
            case R.id.txt_fragmentOutsideFlight_destination:
                getCities(REQUEST_ADD_DESTINATION_CITY);
                break;
            case R.id.txt_fragmentOutsideFlight_date:
                getDate();
                break;
            case R.id.btn_fragmentOutsideFlight_search:
                showAllCities();
                break;
        }
    }
    ...
    private void showAllCities() {
        ...
        intent.putExtra("type", "outsideFlight");
